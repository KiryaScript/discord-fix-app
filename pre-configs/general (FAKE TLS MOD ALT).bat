...
::ZQ05rAF9IAHYFVzEqQI3LRVRXgWOfCOcJ545qNzX3KqqjWlddc4LMe8=
...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFBBdXg2OAES0A5EO4f7+086IoVgQUewra7P806CmNeIv7kz3dpk/0jdckdNBDQtIQheza084qHtMtWy5MMKSth3gRgjBwGobPiVAq1CQoQQfIPJEropN1ji7nA==
::YB416Ek+ZW8=
::
::
...
set LIST_TITLE=general_FAKE_TLS_MOD_ALT
...
--filter-tcp=443 --ipset="%CLOUDFLARE_IPSET_PATH%" --dpi-desync=fake --dpi-desync-fooling=md5sig --dpi-desync-fake-tls-mod=rnd,rndsni,padencap
