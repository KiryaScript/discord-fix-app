...
::
::YAwzoRdxOk+EWAjk
::fBw5plQjdCyDJGyX8VAjFBBdXg2OAE+1EbsQ5+n//NaOoUJTXeEwGA==
...
::ZQ05rAF9IAHYFVzEqQI3LRVRXgWOfCObKoFViA==
...
::dhA7pRFwIByZRRk0BPLrmfflrrRXjYsK2wXMWQpLN1pVEpCsv1LmOD8MamQ+/1HwW6RUr9adCMqLKS680quMzsLL
::Zh4grVQjdCyDJGyX8VAjFBBdXg2OAES0A5EO4f7+086IoVgQUewra7P806CmNeIv7kz3dpk/0jdckdNBDQtIQheza084qHtMtWy5MMKSth3gRgjBx2cEUitxn2aw
::YB416Ek+ZW8=
::
::
...
--filter-tcp=443 --hostlist="%LIST_PATH%" --dpi-desync=fake,split --dpi-desync-autottl=5 --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls="%BIN%tls_clienthello_www_google_com.bin" --new ^
...
--filter-tcp=443 --ipset="%CLOUDFLARE_IPSET_PATH%" --dpi-desync=fake,split --dpi-desync-autottl=5 --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls="%BIN%tls_clienthello_www_google_com.bin"